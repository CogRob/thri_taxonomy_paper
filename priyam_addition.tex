...
\begin{itemize}{}
  \item Physical or tactical knowledge about actuating the sub-task which is necessary for a task of
    physical nature
  \item Conceptual or operational knowledge about which features in the environment, and the team
    ...
    interactions.
  \item Strategic knowledge about the over-arching mission priorities, which is mapped to
    cognitive-reasoning nature of tasks.
  \item Social knowledge about the outward appearance of the system, which is mapped to social
    nature of sub-tasks.
\end{itemize}
